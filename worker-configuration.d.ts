/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 04b87fc0ae36f4f4a1147af2d9fb2376)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOMBOT_AUTH">> {}
}
