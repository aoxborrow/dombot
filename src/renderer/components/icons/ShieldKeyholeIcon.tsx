...
/**
 * Solid shield with a keyhole — Solar "shield-keyhole" (bold). The "privacy
 * on" glyph in the Domains table; {@link ShieldCrossIcon} is its off state.
 * Fills with `currentColor` so `text-*` classes tint it, and sizes from
 * `size-*` / width-height classes.
 */
